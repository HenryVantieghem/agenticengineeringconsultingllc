...
export const emailProviders: EnrichmentProvider[] = [
  smtpVerifier,
  hunter,
  snov,
  apollo,
...
export const phoneProviders: EnrichmentProvider[] = [
  lusha,
  apollo,
  rocketreach,
  snov,
...
export const personProviders: EnrichmentProvider[] = [
  apollo,
  pdl,
  rocketreach,
  prospeo,
...
export const companyProviders: EnrichmentProvider[] = [
  apollo,
  pdl,
  hunter,
];
...
export const decisionMakerProviders: EnrichmentProvider[] = [
  apollo,
  hunter,
  rocketreach,
  pdl,
...
export const verificationProviders: EnrichmentProvider[] = [
  smtpVerifier,
  hunter,
];
...
export const allProviders: EnrichmentProvider[] = [
  smtpVerifier,
  hunter,
  snov,
  apollo,
